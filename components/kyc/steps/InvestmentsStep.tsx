...
const InvestmentsStep: React.FC<InvestmentsStepProps> = ({ formData, updateData, onNext, onPrev }) => {
    ...
    const updateInvestmentItemField = (
                ...
                if (loanFields.includes(field as string)) {
                    ...
                    if (balance > 0 && rate > 0 && tenure > 0) {
                        ...
                        if (remainingMonths > 0) {
                            // Reducing Balance Method for everything
                                    ...
                                    <div>
                                        ...
                                        <div className="relative mt-1">
                                            ...
                                            <DebouncedNumberInput
                                                ...
                                                onChange={(val) => updateInvestmentItemField(collectionPath, item.id, 'monthlyIncome', val)}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative mt-1">
                                            ...
                                            <DebouncedNumberInput
                                                ...
                                                onChange={(val) => updateInvestmentItemField(collectionPath, item.id, 'monthlyExpenses', val)}
                                            />
                                        </div>
                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex gap-2 mt-1">
                                                        <select
                                                            ...
                                                            onChange={(e) => updateInvestmentItemField(collectionPath, item.id, 'loanEndMonth', e.target.value)}
                                                        >
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => updateInvestmentItemField(collectionPath, item.id, 'loanEndYear', e.target.value)}
                                                        />
                                                    </div>
                                                </div>
                                                <div className="col-span-1 md:col-span-2">
                                                    ...
                                                    <div className="relative mt-1">
                                                        ...
                                                        <DebouncedNumberInput
                                                            ...
                                                            onChange={(val) => updateInvestmentItemField(collectionPath, item.id, 'monthlyInstallment', val)}
                                                        />
                                                    </div>
                                                </div>
                                            </div>
