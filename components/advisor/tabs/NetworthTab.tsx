...
export const ASSET_OPTS: [string,string][] = [['savings','Savings'],['fixed_deposit','Fixed Deposit'],['money_market','Money Market'],['epf_account_1','EPF Acc 1'],['epf_account_2','EPF Acc 2'],['epf_account_3','EPF Acc 3'],['unit_trust','Unit Trust'],['stock','Stock'],['bond','Bond'],['etf','ETF'],['property','Property'],['vehicle','Vehicle'],['business','Business'],['other','Other']];
export const LIAB_OPTS: [string,string][] = [['mortgage','Mortgage'],['car_loan','Car Loan'],['personal_loan','Personal Loan'],['study_loan','Study Loan'],['renovation_loan','Renovation Loan'],['credit_card','Credit Card'],['business_loan','Business Loan'],['other','Other']];
